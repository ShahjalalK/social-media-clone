  ...
  return (
    <div className="bg-white shadow border border-gray-300 py-2 px-5 rounded-lg">
        <div className="flex items-center space-x-2">
            ...
            }} className="border rounded-full py-2 text-gray-600 border-gray-300 w-full hover:bg-gray-100 text-start px-5">Start a post</button>
        </div>
        <div className="flex items-center justify-between mt-1 whitespace-nowrap">
          <div  onClick={() => {
            ...
            }} className="flex items-center space-x-2 py-4 px-2 hover:bg-gray-100 cursor-pointer rounded">
